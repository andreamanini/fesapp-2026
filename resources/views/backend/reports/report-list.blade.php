        ...
        <div class="col-lg-12">
            ...
            <div class="block block-themed">
                <div class="block-header fes-gr-colr">
                    <h3 class="block-title font-w700">Lista Rapportini</h3>
                </div>
                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <a id="index" class="navbar-brand float-right" href="{{route('all_report_pdf')}}?date_from={{ $dateFrom->format('d-m-Y') ?? '' }}&date_to={{ $dateTo->format('d-m-Y') ?? '' }}&building_site_id=@if(isset($_GET['building_site_id'])){{$_GET['building_site_id']}}@endif&eid=@if(isset($_GET['eid'])){{$_GET['eid']}}@endif">
                    ...
                    <table class="table table-bordered table-striped table-vcenter">
                        ...
                        @if($reports->count() > 0)
                            ...
                            @foreach($reports as $report)
                                @php
                                    ...
                                    $actualday = $nextday;
                                @endphp
                                @component('backend.components.report-table-row', [
                                    'report' => $report,
                                    'loop' => $loop,
                                    'rowcolor' => $rowcolor
                                ])@endcomponent
                        ...
                        @else
                            <tr>
                                <td colspan="5">
                                    Non sono presenti rapportini da mostrare associati al mese di ricerca.
                                </td>
                            </tr>
                        @endif
                        </tbody>
            ...
            var dateFormat = "dd-mm-yy",
                from = $("#df")
                    ...
                    .on("change", function() {
                        ...
                        location.href = '{{ route('report_list') }}?date_from=' + $("#df").val() +
                            '&date_to=' + $('#dt').val() +

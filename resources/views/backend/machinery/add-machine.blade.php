    ...
    <div class="col-lg-12">
        ...
        <div class="block block-themed">
            <div class="block-header fes-gr-colr">
                <h3 class="block-title font-w700">Mezzi di trasporto e macchine operatrici</h3>
            </div>
            <div class="block-content">
                <form method="POST"
                    ...
                    <input type="hidden" name="machine_type" value="vehicle" />
                    ...
                    <div class="form-group row">
                        <div class="col-6">
                            <label for="machine_name">Nome del mezzo</label>
                        ...
                        <div class="col-6">
                            <label for="machine_number">Numero del mezzo</label>
